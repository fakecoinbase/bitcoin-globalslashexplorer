...
module.exports = {
	...
	logoUrlsByNetwork:{
		...
		"test":"/img/logo/tbg.png",
		"regtest":"/img/logo/rbg.png"
	},
	siteTitlesByNetwork: {
		"main":"Bitcoin Global",
		"test":"Bitcoin Global Testnet",
		"regtest":"Bitcoin Global Regtest"
	},
	...
	maxSupplyByNetwork: {
		"main": new Decimal(21999817.31308491),
		"test": new Decimal(21050000),
		"regtest": new Decimal(21000000)
	},
	targetBlockTimeSeconds: 600,
	targetBlockTimeMinutes: 10,
	currencyUnits:currencyUnits,
	currencyUnitsByName:{"BG":currencyUnits[0], "mBG":currencyUnits[1], "bits":currencyUnits[2], "sat":currencyUnits[3]},
	...
	historicalData: [
		...
		},
		{
			...
			alertBodyHtml: "In this first-known BG-to-fiat transaction, 5,050 BG were exchanged for 5.02 USD, at an effective exchange rate of ~0.001 USD/BG.",
		...
		},
		{
			...
			summary: "First block of subsidy era #2 (25 BG).",
		...
		},
		{
			...
			summary: "First block of subsidy era #3 (12.5 BG).",
			referenceUrl: "https://github.com/bitcoin/bitcoin/blob/master/src/validation.cpp#L1240"
		},
		{
			type: "blockheight",
			...
			summary: "First block of subsidy era #4 (6.25 BG).",
			referenceUrl: "https://github.com/bitcoin/bitcoin/blob/master/src/validation.cpp#L1240"
		},
		{
			type: "blockheight",
			...
			alertBodyHtml: "With the coinbase message 'Times 09/Apr/2020 With $2.3T Injection, Fed's Plan Far Exceeds 2008 Rescue', this final block of subsidy era #3 (12.5 BG) echoes the spiritual call-to-action of <a href='/block/000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f'>Satoshi's genesis block</a>.",
		},
		{
			type: "tx",
			date: "2017-08-24",
		...
		},
		{
			...
			alertBodyHtml: "This is the famous 'Bitcoin Pizza' transaction, one of the earliest 'real-world' transactions, in which 10,000 BG was paid for 2 large pizzas worth ~41 USD (at an effective exchange rate of ~$0.04/BG).",
		...
		},
		{
			...
			alertBodyHtml: "This coinbase transaction completely fails to collect the block's mining reward. 12.5 BG were lost.",
		...
		},
		{
			...
			alertBodyHtml: "On May 5, 2020, 50 BG mined on Feb 9, 2009 (~1 month after Satoshi mined the Genesis block), moved unexpectedly after being dormant for 11+ years. Some observers wondered if they were coins from Satoshi's stash (they likely <a href='https://twitter.com/zackvoell/status/1263120133054255104'>were not</a>) and got excited.",
	...
	blockRewardFunction:function(blockHeight, chain) {
		var hardForkHeight = -1, hardForkLength = 0, hardForkReward = 0;
		if(chain == "main") {
			hardForkHeight = 638592;
			hardForkLength = 100;
			hardForkReward = 1000;
		} else if(chain == "test") {
			hardForkHeight = 1780318;
			hardForkLength = 50;
			hardForkReward = 1000;
		}

		if(blockHeight >= hardForkHeight && blockHeight < (hardForkHeight + hardForkLength)) {
			return hardForkReward;
		}
